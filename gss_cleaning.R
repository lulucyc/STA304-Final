...
raw_data <- read_csv("/Users/lulu/Downloads/AAk5z98S.csv")
dict <- read_lines("/Users/lulu/Downloads/gss_dict.txt", skip = 18) # skip is because of preamble content
# Now we need the labels because these are the actual responses that we need
labels_raw <- read_file("/Users/lulu/Downloads/gss_labels.txt")
...
# working directory
write_csv(reduced_data, "census_data_2017.csv")
